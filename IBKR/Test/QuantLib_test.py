...
optionType = P
optionTypeBlack76 = True if optionType == C else False
...
put_bid, put_ask, put_delta, put_gamma, put_vega, put_rho, put_impliedVol, put_optPrice, put_undPrice, put_ttm, put_expiryDateTime  = requestBidAskandGreeks(ib, optionPut)
