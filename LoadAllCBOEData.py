...
def setup_custom_logger(name):
    formatter = logging.Formatter(fmt='%(asctime)s %(levelname)-8s %(message)s',
                                  datefmt='%Y-%m-%d %H:%M:%S')
    handler = logging.FileHandler("C:\\temp\Vol\CBOENewLogger.txt", mode='w')
...
with open("C:\\Users\Tom\PycharmProjects\Vol\Historical_CBOE_Download.py") as f:
...
print('https://www.cboe.com/us/futures/market_statistics/settlement/')
